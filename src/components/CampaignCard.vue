<template>
  ...
  <section v-if="section === 'hero' || section === 'full'" class="w-full animate-fade-up">
    <p class="text-xs text-zinc-500 uppercase tracking-[0.2em] mb-4 font-medium">Live Campaign</p>
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-3">
      ...
      <div v-if="campaign.title" class="self-start shrink-0 mt-1">
        <!-- Active -->
        <span v-if="!isEnded && !campaign.goalReached"
        ...
        <!-- Goal Reached -->
        <span v-else-if="campaign.goalReached"
  ...
  <div v-if="section === 'stats' || section === 'full'" class="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-7 space-y-6 animate-fade-up" style="animation-delay: 150ms">
    ...
    <div v-if="loading" class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-3 mt-6">
        <div v-for="i in 4" :key="i" class="h-20 bg-white/5 rounded-xl animate-pulse"></div>
      </div>
    </div>
    ...
    <template v-else>
      ...
      <div class="space-y-3">
        <div class="flex items-center justify-between text-sm">
          ...
          <span class="text-white font-bold tabular-nums text-base">{{ progressPercent }}%</span>
        </div>
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        >
          <div class="flex items-center gap-1.5">
            ...
            <p class="text-zinc-500 text-xs font-medium uppercase tracking-widest leading-none">{{ stat.label }}</p>
          </div>
